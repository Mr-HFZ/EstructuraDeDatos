...
class ReinoDeEquilibria:
    ...
    def verificar_estadisticas(self):
        """Verifica si alguna estadística llegó a 0 o menos."""
        for stat, valor in self.stats.items():
            if valor <= 0:
                print(f"\n¡El juego ha terminado! '{stat}' ha llegado a 0.")
                return True
        return False
    ...
    def jugar(self):
        ...
        try:
            ...
            while self.nodo_actual:
                ...
                # Verificar si alguna estadística llegó a 0
                if self.verificar_estadisticas():
                    self.nodo_actual = None  # Forzar fin del juego
                    break
                ...
                # Verificar nuevamente después de aplicar consecuencias
                if self.verificar_estadisticas():
                    self.nodo_actual = None  # Forzar fin del juego
